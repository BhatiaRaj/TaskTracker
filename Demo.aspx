                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card text-white bg-flat-color-1">
                            <div class="card-body pb-0">
                                <h4 class="mb-0">
                                    <span class="count">
                                        <asp:Label ID="Label005" runat="server"></asp:Label></span>
                                </h4>
                                <p class="text-light">Complete Task</p>
                   ...
                   <div class="col-xl-3 col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="menu-icon fa fa-building"></i></div>
                                    <div class="stat-content dib">
                                        <div class="stat-text">Department</div>
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="menu-icon fa fa-cog"></i></div>
                                    <div class="stat-content dib">
                                        <div class="stat-text">Designation</div>
                                        <div class="stat-digit">
                                            <span class="count">
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="menu-icon fa fa-list"></i></div>
                                    <div class="stat-content dib">
                                        <div class="stat-text">Type Of Work</div>
                                        <div class="stat-digit">
                                            <span class="count">
