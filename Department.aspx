<%@ Page Title="" Language="C#" MasterPageFile="~/TaskTracker.master" AutoEventWireup="true" CodeFile="Department.aspx.cs" Inherits="Department" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="auto-style1">
        <tr>
            ...
            <td>
                <asp:TextBox ID="dprname" runat="server" CssClass="form__input"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="dprname" ErrorMessage="*" ForeColor="#DB0000"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td colspan="2"><center>
                <asp:Button ID="departmentsubmit" runat="server" OnClick="departmentsubmit_Click" Text="Submit" CssClass="button1"/>
            </td></center>
        </tr>
