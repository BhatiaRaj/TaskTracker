...
public partial class Customer : System.Web.UI.Page
{
    ...
    protected void custsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (editid == 0)
        {
            ...
            System.Net.Mail.MailAddress toAddress1 = new System.Net.Mail.MailAddress(customeremail.Text);
            ...
            MyMail1.Subject = "Account Creation on Task Tracker";


            MyMail1.Body = "Your login user id is your EMAIL ADDRESS and Password is " + passtxt.Text;
